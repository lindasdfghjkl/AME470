...
app.get("/saveFilter", function (req, res) {
    var id = req.query.id.toString();
    var blur = req.query.blur.toString();
    var saturate = req.query.saturate.toString();
    var brightness = req.query.brightness.toString();
    var contrast = req.query.contrast.toString();
    var hue = req.query.hue.toString();
    var invert = req.query.invert.toString();
